...
param viteRemix1Exists bool
@secure()
param viteRemix1Definition object
...
module viteRemix1 './app/vite-remix-1.bicep' = {
  name: 'vite-remix-1'
  params: {
    name: '${abbrs.appContainerApps}vite-remix-1-${resourceToken}'
    location: location
    tags: tags
    identityName: '${abbrs.managedIdentityUserAssignedIdentities}vite-remix-1-${resourceToken}'
    applicationInsightsName: monitoring.outputs.applicationInsightsName
